...
`swiftui-specialist.idechatprompttemplate` and the nine
`swiftui-specialist-ref-*.md.packaged` files.
...
agents:
    ...
    ~/.claude/skills/swiftui-specialist    -> ../../.agents/skills/swiftui-specialist
    ~/.pi/agent/skills/swiftui-specialist  -> ../../../../../.agents/skills/swiftui-specialist
