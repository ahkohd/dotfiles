...
`audit-xcode-security-settings.idechatprompttemplate` and the nine
`audit-xcode-security-settings-ref-*.md.packaged` files.
...
agents:
    ...
    ~/.claude/skills/audit-xcode-security-settings    -> ../../.agents/skills/audit-xcode-security-settings
    ~/.pi/agent/skills/audit-xcode-security-settings  -> ../../../../../.agents/skills/audit-xcode-security-settings
