...
`swiftui-whats-new-27.idechatprompttemplate` and the nine
`swiftui-whats-new-27-ref-*.md.packaged` files.
...
agents:
    ...
    ~/.claude/skills/swiftui-whats-new-27    -> ../../.agents/skills/swiftui-whats-new-27
    ~/.pi/agent/skills/swiftui-whats-new-27  -> ../../../../../.agents/skills/swiftui-whats-new-27
