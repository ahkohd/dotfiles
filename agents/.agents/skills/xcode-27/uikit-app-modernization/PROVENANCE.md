...
`uikit-app-modernization.idechatprompttemplate` and the nine
`uikit-app-modernization-ref-*.md.packaged` files.
...
agents:
    ...
    ~/.claude/skills/uikit-app-modernization    -> ../../.agents/skills/uikit-app-modernization
    ~/.pi/agent/skills/uikit-app-modernization  -> ../../../../../.agents/skills/uikit-app-modernization
