...
- Avoid metaphors and cliches: drive, unlock, deep dive, robust, key, ring-fence, hub, portal, landscape, ecosystem, going forward.
...
- Numbers: write "one" but use numerals from 2 upwards (2, 9, 25). Use the % symbol with numerals (50%). Use GBP with no decimals unless there are pence (GBP 75, GBP 75.50). Spell out millions and billions (GBP 5 million, not GBP 5m). Write ranges with "to", not a hyphen (10 to 20, Monday to Friday).
