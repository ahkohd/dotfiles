...
<dict>
	<key>author</key>
	<string>Zenn Meche (http://github.com/nojvspine)</string>
	<key>colorSpaceName</key>
	<string>sRGB</string>
	<key>name</key>
	<string>Wallust Theme</string>
	<key>semanticClass</key>
	<string>theme.wallust</string>
	<key>settings</key>
	<array>
		<dict>
			<key>settings</key>
			<dict>
				...
				<string>{{color0}}</string>
				<key>foreground</key>
				<string>{{color7}}ff</string>
				<key>guide</key>
				<string>{{color1}}40</string>
				<key>gutterForeground</key>
				<string>{{color1}}aa</string>
				<key>inactiveSelection</key>
				<string>{{color0}}</string>
				<key>invisibles</key>
				<string>{{color1}}</string>
				<key>lineHighlight</key>
				<string>{{color0}}30</string>
				<key>phantomCss</key>
				<string>&lt;![CDATA[ html { position: relative; } ]]&gt;</string>
				<key>popupCss</key>
				<string>&lt;![CDATA[ html { color: {{color9}}; background-color: {{color0}}; padding: 10px; } a { color: {{color3}}; line-height: 1.2; text-decoration: none; } .error, .deleted { color: {{color10}}; } .success, .inserted { color: #9dbA72; } .warning, .modified { color: {{color11}}; } ]]&gt;</string>
				<key>selection</key>
				<string>{{color9}}40</string>
				<key>selectionBorder</key>
				<string>{{color9}}</string>
				<key>shadow</key>
				<string>{{color0}}10</string>
				<key>stackGuide</key>
				<string>{{color1}}60</string>
				<key>tagsOptions</key>
