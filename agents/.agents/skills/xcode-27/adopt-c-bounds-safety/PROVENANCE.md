...
`adopt-c-bounds-safety.idechatprompttemplate` and the nine
`adopt-c-bounds-safety-ref-*.md.packaged` files.
...
agents:
    ...
    ~/.claude/skills/adopt-c-bounds-safety    -> ../../.agents/skills/adopt-c-bounds-safety
    ~/.pi/agent/skills/adopt-c-bounds-safety  -> ../../../../../.agents/skills/adopt-c-bounds-safety
